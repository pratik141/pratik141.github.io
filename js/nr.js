...
NREUM.loader_config = { accountID: "3407430", trustKey: "3407430", agentID: "538492609", licenseKey: "NRJS-1119f120f03239f1f85", applicationID: "538492609" };
NREUM.info = {
    beacon: "bam.eu01.nr-data.net",
    errorBeacon: "bam.eu01.nr-data.net",
    licenseKey: "NRJS-1119f120f03239f1f85",
    applicationID: "538492609",
    sa: 1,
...
(() => {
    ...
    var e,
        ...
        r = {
            ...
            385: (e, t, r) => {
                r.d(t, { FN: () => a, IF: () => u, Nk: () => f, Tt: () => s, _A: () => o, il: () => n, pL: () => c, v6: () => i, w1: () => d });
                const n = "undefined" != typeof window && !!window.document,
                    ...
                    o = n
                        ? window
                        : "undefined" != typeof WorkerGlobalScope && (("undefined" != typeof self && self instanceof WorkerGlobalScope && self) || ("undefined" != typeof globalThis && globalThis instanceof WorkerGlobalScope && globalThis)),
                    a = "" + o?.location,
            ...
            2587: (e, t, r) => {
                ...
                var n = r(2177),
                    ...
                    o = r(8e3),
                    a = r(3325);
                const s = { stn: [a.D.sessionTrace], err: [a.D.jserrors, a.D.metrics], ins: [a.D.pageAction], spa: [a.D.spa], sr: [a.D.sessionReplay, a.D.sessionTrace] };
                function c(e, t) {
                    const r = n.ee.get(t);
                    e &&
                        "object" == typeof e &&
            ...
            1214: (e, t, r) => {
                r.d(t, { em: () => v, u5: () => N, QU: () => S, _L: () => I, Gm: () => L, Lg: () => M, gy: () => U, BV: () => Q, Kf: () => ee });
                var n = r(2177);
                const i = "nr@original";
            ...
            9144: (e, t, r) => {
                ...
                function m(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        ...
                        { init: b, info: y, loader_config: w, runtime: x = { loaderType: m }, exposed: A = !0 } = t;
                    const E = (0, h.gG)();
    ...
    (() => {
        ...
        function w(e, t) {
            return null == e
                ...
                : t
                ? (t.c || (t = x(t.t)), (t.c += 1), (t.t += e), (t.sos += e * e), e > t.max && (t.max = e), e < t.min && (t.min = e), t)
                : { t: e };
        }
        function x(e) {
            ...
            constructor(e, r) {
                ...
                super(e, r, j.t, n),
                    c.il &&
                        ...
                        (0, N.N)(() => (0, s.p)("docHidden", [(0, p.z)()], void 0, j.t, this.ee), !0),
                        (0, O.bP)("pagehide", () => (0, s.p)("winPagehide", [(0, p.z)()], void 0, j.t, this.ee)),
                        this.importAggregator());
            }
        }
        var P = i(3081);
        ...
        var ue = i(7836);
        const { FEATURE_NAME: de, START: fe, END: le, BODY: he, CB_END: ge, JS_TIME: pe, FETCH: me, FN_START: ve, CB_START: be, FN_END: ye } = ue;
        var we = i(4649);
        class xe extends h {
            ...
            constructor(e) {
                ...
                c._A
                    ? ((this.agentIdentifier = t),
                      (this.sharedAggregator = new y({ agentIdentifier: this.agentIdentifier })),
                      (this.features = {}),
                      ...
                      this.start())
                    : (0, l.Z)("Failed to initial the agent. Could not determine the runtime environment.");
            }
            get config() {
                    ...
                    i.sort((t, r) => e.p[t.featureName] - e.p[r.featureName]),
                        i.forEach((t) => {
                            if (r[t.featureName] || t.featureName === e.D.pageViewEvent) {
                                ...
                                n.every((e) => r[e]) ||
                                    (0, l.Z)("".concat(t.featureName, " is enabled but one or more dependent features has been disabled (").concat((0, D.P)(n), "). This may cause unintended consequences or missing data...")),
                ...
                class extends h {
                    ...
                    constructor(e, r) {
                        ...
                        this.ee.on(ve, v),
                            ...
                            u.buffer(["setTimeout" + le, "clearTimeout" + fe, ve], this.featureName),
                            d.buffer([ve, "new-xhr", "send-xhr" + fe], this.featureName),
                            l.buffer([me + fe, me + "-done", me + he + fe, me + he + le], this.featureName),
                            h.buffer(["newURL"], this.featureName),
                            g.buffer([ve], this.featureName),
                            s.buffer(["propagate", be, ge, "executor-err", "resolve" + fe], this.featureName),
                            ...
                            window.addEventListener("hashchange", m, (0, O.m$)(!0, this.removeOnAbort?.signal)),
                            window.addEventListener("load", m, (0, O.m$)(!0, this.removeOnAbort?.signal)),
